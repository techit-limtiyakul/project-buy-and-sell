"""
Django settings for UCSDBuyAndSell project.
...
SECRET_KEY = 'r#)pdysojr!xc=&%gncz7bc8-n78zrrkvpxaq@qu%oxp-r=$gy'
...
ROOT_URLCONF = 'UCSDBuyAndSell.urls'
...
WSGI_APPLICATION = 'UCSDBuyAndSell.wsgi.application'
